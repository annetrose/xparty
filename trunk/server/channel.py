...
def send_student_action(student, task_idx, action_type, action_data):
    action_data["task_idx"] = task_idx
    _send_message_to_teacher(student, action_type, action_data)
...
def _send_message_to_teacher(student, action_type, action_data={}):
    msg = { "student_nickname":student.nickname, "lesson_code":student.lesson.lesson_code, "action_type":action_type, "action_data":action_data}
